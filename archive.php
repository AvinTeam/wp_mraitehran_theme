...
<div class=" bg-primary text-center py-5">
    <div class="container mx-auto d-flex flex-column-reverse flex-md-row justify-content-between align-items-center">
...
<?php
    ...
    if ($current_category->slug == 'gallery') {
        $layout_archive = 'gallery';
    } elseif ($current_category->slug == 'edu') {
        $layout_archive = 'edu';

    }

    require_once MRTAI_VIEWS . "layout/$layout_archive.php";
...
<div class="zba-row mx-auto mt-4  d-none">
    <!-- لیست پست‌ها -->
