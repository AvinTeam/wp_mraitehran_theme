...
<div class=" row row-cols-1 row-cols-md-2 row-cols-lg-3 justify-content-around align-items-center">
<a class="col" href="/category/edu/image-training/"><img class="p-1 my-2 mrtai-cat-img"
            src="<?php echo mrtai_image('cat-image.png') ?>"></a>
    <a class="col" href="/category/edu/graphics-training/"><img class="p-1 my-2 mrtai-cat-img"
            src="<?php echo mrtai_image('cat-graphics.png') ?>"></a>
    <a class="col" href="/category/edu/programming-training/"><img class="p-1 my-2 mrtai-cat-img"
            src="<?php echo mrtai_image('cat-programming.png') ?>"></a>
    <a class="col" class="col" a href="/category/edu/digital-game-training/"><img class="p-1 my-2 mrtai-cat-img"
            src="<?php echo mrtai_image('cat-game.png') ?>"></a>
    <a class="col" href="/category/edu/teaching-correspondence/"><img class="p-1 my-2 mrtai-cat-img"
            src="<?php echo mrtai_image('cat-text.png') ?>"></a>
    <a class="col" href="/category/edu/music-education/"><img class="p-1 my-2 mrtai-cat-img"
...
<div class="container mt-4 d-flex flex-column  flex-lg-row  ">
    ...
    <div class="col-12 col-lg-4">
        ...
        <div class=" d-flex flex-row justify-content-start align-items-center p-3">
            <span class="text-white text-center py-2 px-5 f-22px fw-bold bg-warning rounded-5">سایر آموزش</span>
        </div>
